...
from klir.config import reset_gemini_models, set_gemini_models
from klir.orchestrator.core import Orchestrator
from klir.orchestrator.selectors.model_selector import (
...
def _patch_auth(auth_map: dict[str, AuthResult]) -> Any:
    return patch(
        "klir.orchestrator.selectors.model_selector.check_all_auth",
